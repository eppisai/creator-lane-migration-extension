(function(){function F(t,e){return e?Array.from(t.querySelectorAll(e)):[]}function mt(t,e){return e?t.querySelector(e):null}function V(t,e){if(!e)return null;for(const n of e.split(",").map(o=>o.trim()).filter(Boolean))try{const o=t.querySelector(n);if(o)return o}catch{}return null}async function it(t,e=15e3){if(!t)return null;const n=Date.now();return new Promise((o,r)=>{const a=()=>{const s=document.querySelector(t.split(",")[0].trim());if(s)return o(s);if(Date.now()-n>e)return r(new Error(`waitForSelector timed out: ${t}`));setTimeout(a,200)};a()})}function x(t){return new Promise(e=>setTimeout(e,t))}const X="__creatorlane_migration_overlay__",j="__cl_migration_highlight__",i={bg:"#0a0a0a",bg2:"#0f0f10",fg:"#f5f5f5",fg2:"#b3b3b3",fg3:"#71717a",border:"rgba(255,255,255,0.08)",acc:"#3b82f6",accSoft:"rgba(59,130,246,0.14)",accFg:"#60a5fa",success:"#10b981",danger:"#f87171"},U='-apple-system, BlinkMacSystemFont, "Segoe UI", Inter, sans-serif',G='ui-monospace, SFMono-Regular, "JetBrains Mono", Menlo, Consolas, monospace',ft='"Iowan Old Style", Georgia, "Times New Roman", serif';let d=null,v=null,S=null,k=null,I=null,B=null,E=null;function z(){if(d&&document.body.contains(d))return d;const t=document.getElementById(X);t&&t.remove(),d=document.createElement("div"),d.id=X,d.setAttribute("data-creatorlane","migration"),d.style.cssText=`
  ...
  `,B.textContent="",E=document.createElement("div"),E.style.cssText=`
    ...
    line-height:1.5;
  `,d.appendChild(e),d.appendChild(v),d.appendChild(S),d.appendChild(k),d.appendChild(a),d.appendChild(B),d.appendChild(E),document.body.appendChild(d),d}function gt(t){const e=(t||"").toLowerCase();return e.includes("log in")?"Step 02 — Sign in":e.includes("logged in")||e.includes("starting")?"Step 03 — Reading":e.includes("loading")?"Step 03 — Loading list":e.includes("scraping")?"Step 04 — Scraping":e.includes("sending")?"Step 05 — Importing":e.includes("imported")?"Done":e.includes("navigat")?"Step 02 — Routing":"Step 01 — Boot"}function R(t,e){z(),t!=null&&(S.textContent=t,S.style.color=i.fg,v.textContent=gt(t),v.style.color=i.fg2),e!=null&&(k.textContent=e,k.style.color=i.fg2)}function H(t,e){if(z(),typeof t!="number"||typeof e!="number"||e<=0){I.style.width="0%",B.textContent="";return}const n=Math.max(0,Math.min(100,Math.round(t/e*100)));I.style.width=`${n}%`,I.style.background=i.acc,B.textContent=`${t} / ${e}`}function _(t){z(),E.style.display="block";const e=document.createElement("div"),n=document.createElement("span");for(n.textContent="›",n.style.cssText=`color:${i.accFg};margin-right:6px;`,e.appendChild(n),e.appendChild(document.createTextNode(t)),e.style.cssText=`padding:2px 0;color:${i.fg3};`,E.appendChild(e),E.scrollTop=E.scrollHeight;E.children.length>30;)E.removeChild(E.firstChild)}function N(t){z(),v.textContent="Error",v.style.color=i.danger,S.textContent="Something went wrong",S.style.color=i.danger,k.textContent=t,k.style.color=i.fg2,I.style.background=i.danger}function ht(t,e){z(),v.textContent="Done",v.style.color=i.success,S.textContent="";const n=document.createElement("span");n.textContent="Migrated — ",n.style.color=i.fg;const o=document.createElement("em");o.textContent=t,o.style.cssText=`
    font-family:${ft};
    font-style:italic;font-weight:400;
    color:${i.acc};
  `,S.appendChild(n),S.appendChild(o),k.textContent=e||"",k.style.color=i.fg2,I.style.background=i.success,I.style.width="100%"}let tt=!1;function yt(){if(tt)return;const t=document.createElement("style");t.textContent=`
    .${j} {
  ...
  `,f.innerHTML=`
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="filter: drop-shadow(0 2px 8px rgba(0,0,0,0.55));">
      <path d="M5 3 L5 18 L9 14 L11.5 19.5 L13.5 18.5 L11 13 L17 13 Z" fill="${g.fg}" stroke="${g.bg}" stroke-width="1.2" stroke-linejoin="round"/>
    </svg>
  ...
  `;const n=document.createElement("span");n.textContent="Creator Lane",n.style.cssText=`font-weight:600;color:${g.fg};`;const o=document.createElement("span");o.textContent="·",o.style.cssText=`color:${g.fg};opacity:0.45;margin:0 4px;`;const r=document.createElement("span");r.textContent="is now",r.style.cssText=`color:${g.fg};opacity:0.85;`;const a=document.createElement("em");a.textContent="migrating your automations.",a.style.cssText=`
    font-family:${Ct};
    font-style:italic;font-weight:400;
    color:${g.acc};
    margin-left:6px;
  `,t.appendChild(e),t.appendChild(n),t.appendChild(o),t.appendChild(r),t.appendChild(a),document.body.appendChild(t),document.documentElement.style.scrollPaddingTop="44px"}function Et(){const t=document.getElementById(Q);t&&t.remove()}function q(t){if(lt(),!t){P.style.opacity="0";return}P.textContent=t,P.style.opacity="1"}async function pt(t,e={}){lt();let n,o;if(t&&t.nodeType===1){await $t(t)||(t.scrollIntoView({behavior:"smooth",block:"center"}),await J(450));const r=ut(t);n=r.x,o=r.y}else if(t&&typeof t.x=="number")n=t.x,o=t.y;else return;ct(n,o),await J(e.duration||420)}function vt(t,e){const n=document.createElement("div");n.style.cssText=`
    ...
    height: 26px;
    border-radius: 50%;
    background: ${g.accSoft};
    border: 2px solid ${g.acc};
    pointer-events: none;
    z-index: 2147483646;
    transform: translate(-50%,-50%);
    animation: __cl_click_pulse 520ms ease-out forwards;
  `,document.body.appendChild(n),setTimeout(()=>n.remove(),600)}async function C(t,e){if(!t)return!1;await pt(t),e&&q(e);const n=ut(t);vt(n.x,n.y),await J(180);try{t.click()}catch{t.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window}))}return!0}function kt(){f&&f.parentNode&&f.parentNode.removeChild(f),f=null,P=null,Et()}const D=(...t)=>console.log("[CL-migration]",...t),W=(...t)=>console.warn("[CL-migration]",...t);D("content script boot, url:",location.href);const A={config:null,inProgress:!1};function M(t,e,{multi:n=!1}={}){if(!e)return null;const o=e.selector;if(!o||o==="TBD")return null;if(n)return F(t,o).map(s=>nt(s,e.attr||"text")).filter(Boolean);const r=mt(t,o);return r?nt(r,e.attr||"text"):null}function nt(t,e){return e==="text"?(t.textContent||"").trim():e==="html"?t.innerHTML:e==="value"?t.value||t.getAttribute("value")||"":t.getAttribute(e)}function ot(t){if(t?.login_url_match)try{if(new RegExp(t.login_url_match).test(location.href))return!0}catch{}return/\/(login|signin|signup|auth)(\/|\?|$)/i.test(location.href)}async function Tt(t){t.entrypoint_url&&(location.href.startsWith(t.entrypoint_url)||(R("Navigating",`Going to ${new URL(t.entrypoint_url).pathname}…`),location.assign(t.entrypoint_url),await x(6e4)))}async function Lt(t){const e=t.row_selector,n=t.pagination?.idle_ms??1500,o=t.pagination?.max_scrolls??200,r=t.pagination?.scroll_container_selector;R("Loading your automations","Scrolling + paginating through the SuperProfile list…"),q("loading every automation");function a(){if(r){const u=document.querySelector(r);if(u)return u}return document.scrollingElement||document.documentElement||document.body}async function s(){let u=F(document,e).length,h=0;for(let b=0;b<o;b++){const $=a();$.scrollTop=$.scrollHeight,window.scrollTo(0,document.body.scrollHeight),document.querySelectorAll("button, a, [role='button']").forEach(y=>{const L=(y.textContent||"").trim().toLowerCase();if(/^(load|show|view)\s+more$/i.test(L))try{y.click()}catch{}}),await x(n);const T=F(document,e).length;if(T>u?(u=T,h=0):h++,h>=6)break}return u}function c(){if(document.querySelector(".modal.show, .modal.fade.show"))return null;const u=[".pagination",".paging","nav[aria-label*='pagination' i]","[role='navigation'][aria-label*='page' i]"];let h=null;for(const y of u){const L=document.querySelector(y);if(L){h=L;break}}if(!h)return null;const b=h.querySelector(".active, .selected, [aria-current='page']")||null,$=b?parseInt((b.textContent||"").trim(),10):NaN,T=Array.from(h.querySelectorAll("button, a, li, [role='button']"));for(const y of T){if(y.hasAttribute("disabled")||y.classList.contains("disabled")||y.getAttribute("aria-disabled")==="true")continue;const L=(y.textContent||"").trim().toLowerCase(),Z=(y.getAttribute("aria-label")||"").toLowerCase();if(L==="next"||L==="›"||L===">"||/^next$/.test(Z))return y}if(!isNaN($)){for(const y of T)if(parseInt((y.textContent||"").trim(),10)===$+1)return y}return null}let l=await s();_(`page 1: ${l} rows`);let m=location.href,p=l;for(let u=2;u<=50;u++){const h=c();if(!h)break;try{await C(h,`page ${u}`)}catch{break}await x(n);const b=await s();_(`page ${u}: ${b} rows`);const $=location.href!==m;if(m=location.href,!$&&b<=p){_("page nav clicked but no progress — stopping pagination");break}p=b,b>l&&(l=b)}q(`loaded ${l}`);const w=a();return w.scrollTop=0,window.scrollTo(0,0),await x(400),l}async function Rt(t,e){const n=e.open_modal_flow||{},o=V(t,n.dropdown_trigger_selector);if(!o)throw new Error("dropdown_trigger_not_found");await C(o,"open menu"),await x(n.wait_after_trigger_ms??250);let r=V(document,n.dropdown_edit_option_selector)||null;if(!r){const a=F(document,".pl-dropdown-text"),s=(n.dropdown_edit_option_text||"Edit").toLowerCase();r=a.find(c=>(c.textContent||"").trim().toLowerCase()===s)}if(!r)throw new Error("edit_option_not_found");return await C(r,"click Edit"),await it(n.modal_root_selector,n.modal_wait_timeout_ms??8e3),await x(300),document.querySelector(n.modal_root_selector)}async function At(t,e){if(!t)return null;const n=e.step3_link_flow||{},o=n.dm_pencil_selector||".dm-container-main .edit-icon-div",r=t.querySelector(o);if(!r)return null;await C(r,"open DM editor");const a=n.step_body_selector||".a-dm-trigger-main.reel-post-step-3";try{await it(a,n.step_wait_timeout_ms??6e3)}catch{return null}await x(300);const s=n.link_input_selector||'input[id^="link-product-button-"][id$="-primaryMsgCta-link"]';let c=null;for(const p of document.querySelectorAll(s)){const w=p.value||p.getAttribute("value")||"";if(w){c=w;break}}if(!c){const p=[".a-dm-text-button-container",".link-button-container",".modal-body"],w=/^https?:\/\/\S+$/i;for(const u of p){const h=document.querySelector(u);if(!h)continue;const b=h.querySelectorAll("input[type='text'], input:not([type])");for(const $ of b){const T=($.value||$.getAttribute("value")||"").trim();if(w.test(T)){c=T,_(`link_url found via fallback in ${u}`);break}}if(c)break}}c||_("no link_url found in Step 3 — card may have no button configured");const l=n.cancel_button_selector||".modal-footer button.base-button.md-button.tertiary-button";let m=document.querySelector(l);if(m||(m=Array.from(document.querySelectorAll(".modal-footer button")).find(p=>(p.textContent||"").trim().toLowerCase()==="cancel")),m)await C(m,"back to review"),await x(400);else{const p=t.querySelector(".cf-modal-header-content img.cf-close-button");if(p){await C(p,"close (fallback)"),await x(350);const w=Array.from(document.querySelectorAll(".auto-dm-exit-modal .pop-confirm-footer button")).find(u=>(u.textContent||"").trim().toLowerCase()==="exit");w&&await C(w,"discard")}}return c}async function It(t,e){const n=e.modal_fields||{},o={keyword:M(t,n.keyword,{multi:!0}),dm_body:M(t,n.dm_body),comment_reply:M(t,n.comment_reply),caption:M(t,n.caption),thumbnail_src:M(t,n.thumbnail_src)};let r=null;try{r=await At(t,e)}catch(a){_(`link_url capture failed: ${a?.message||a}`)}return{...o,link_url:r}}async function rt(t){const e=t.modal_close_selector,n=e?V(document,e):null;n?await C(n,"close modal"):(q("press Escape"),document.body.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",bubbles:!0})));const o=t.open_modal_flow?.modal_root_selector;if(o)for(let r=0;r<20&&document.querySelector(o);r++)await x(150)}async function Mt(t){const e=t.pagination||{},n=e.items_per_page_trigger_selector||".select-wrapper.pagination-select .select-input",o=e.items_per_page_option_selector||".select-dropdown.open .select-option",r=document.querySelector(n);if(!r)return null;const a=parseInt(r.value||r.getAttribute("value")||"0",10);try{await C(r,"items per page"),await x(350);const s=document.querySelectorAll(o);if(s.length===0)return a;let c=s[s.length-1],l=parseInt((c.textContent||"").trim(),10)||0;for(const m of s){const p=parseInt((m.textContent||"").trim(),10)||0;p>l&&(c=m,l=p)}return await C(c,`set ${l}/page`),await x(700),_(`items per page: ${a} → ${l}`),l}catch{return a||null}}function Nt(t){const e=t.pagination||{},n=document.querySelectorAll(".tab, .auto-tabs-item, [class*='automation-tab']");for(const a of n){const s=(a.textContent||"").match(/automations?\s*\((\d+)\)/i);if(s)return parseInt(s[1],10)}const o=document.querySelector(e.pages_label_selector||".pagination-input-container .pagination-number-of-pages"),r=document.querySelector(e.items_per_page_trigger_selector||".select-wrapper.pagination-select .select-input");if(o&&r){const a=(o.textContent||"").match(/(\d+)/),s=parseInt(r.value||"0",10)||0;if(a&&s)return parseInt(a[1],10)*s}return null}async function Pt(t){const e=t.pagination||{};if(document.querySelector(".modal.show, .modal.fade.show"))return!1;const n=e.next_button_selector||".pagination-buttons-container .pagination-button:last-of-type";let o=document.querySelector(n);if(!o){const s=document.querySelector(e.container_selector||".pagination-container");s&&(o=Array.from(s.querySelectorAll("button")).find(c=>(c.textContent||"").trim().toLowerCase()==="next"))}if(!o||o.disabled||o.hasAttribute("disabled")||o.classList.contains("disabled"))return!1;const r=O(t);return await C(o,`page ${r+1}`),await x(e.page_transition_ms||900),O(t)>r}function O(t){const e=t.pagination||{},n=document.querySelector(e.current_page_selector||".pagination-input");return n&&parseInt(n.value||n.getAttribute("value")||"1",10)||1}function qt(t){const e=t.pagination||{},n=document.querySelector(e.pages_label_selector||".pagination-input-container .pagination-number-of-pages");if(!n)return 1;const o=(n.textContent||"").match(/(\d+)/);return o?parseInt(o[1],10):1}async function at(t,e,n){const o=[],r=F(document,t.row_selector).length;for(let a=0;a<r;a++){let c=F(document,t.row_selector)[a];if(!c){o.push({index:e+a,name:null,status:null,scrape_error:"row_not_mounted"}),n&&n(e+a+1);continue}xt(c),q(`automation ${e+a+1}`),await pt(c);const l=t.list_fields||{},m={name:M(c,l.name),status:M(c,l.status)};let p=null,w=null;try{const u=await Rt(c,t);p=await It(u,t),await rt(t),_(`✓ ${m.name||`automation ${e+a+1}`}`)}catch(u){w=u?.message||String(u),_(`× ${m.name||`automation ${e+a+1}`}: ${w}`);try{await rt(t)}catch{}}o.push({index:e+a,name:m.name,status:m.status,...p||{},scrape_error:w}),n&&n(e+a+1)}return o}async function K(t){if(!A.inProgress){A.inProgress=!0;try{dt(),R("Starting scrape","Creator Lane is reading your SuperProfile automations."),q("starting…"),await Tt(t),chrome.runtime.sendMessage({type:"SCRAPE_STARTED"});const e=document.querySelector(t.pagination?.container_selector||".pagination-container");let n=[];if(e){await Mt(t),await x(400);const o=Nt(t),r=qt(t);R(`Scraping ${o||"?"} automations across ${r} page${r===1?"":"s"}`,"Walking page by page."),H(0,o||1);const a=l=>{H(l,o||l),chrome.runtime.sendMessage({type:"SCRAPE_PROGRESS",page:O(t),added:1,total:l,stage:"scraping_modals",of:o||l})};let s=0;const c=new Set;for(;;){const l=O(t);if(c.has(l)){_(`page ${l} already scraped — stopping`);break}c.add(l),_(`-- page ${l} of ${r} --`);const m=await at(t,s,a);if(n.push(...m),s+=m.length,!await Pt(t)){_(`no more pages (current=${O(t)})`);break}}}else{const o=await Lt(t);if(o===0)throw N("Couldn't find any automations on this page. Make sure you're on the SuperProfile auto-DM tab and have at least one automation set up."),new Error("no_rows_found");R(`Scraping ${o} automation${o===1?"":"s"}`,"Opening each automation to read the keyword, DM, and caption."),H(0,o),n=await at(t,0,a=>{H(a,o),chrome.runtime.sendMessage({type:"SCRAPE_PROGRESS",page:1,added:1,total:a,stage:"scraping_modals",of:o})})}if(n.length===0)throw N("Couldn't find any automations. Make sure you're on the SuperProfile auto-DM tab and have at least one automation set up."),new Error("no_rows_found");Y(),R("Sending to Creator Lane",`Uploading ${n.length} automations to create paused campaigns…`),chrome.runtime.sendMessage({type:"SCRAPE_RESULT",rows:n})}catch(e){W("scrape failed:",e),N(e?.message||String(e)),chrome.runtime.sendMessage({type:"SCRAPE_ERROR",error:e?.message||String(e)})}finally{A.inProgress=!1}}}function Bt(){if(ot(A.config)){R("Log in to SuperProfile","We'll continue automatically once you're signed in."),chrome.runtime.sendMessage({type:"NEEDS_LOGIN"});const t=setInterval(()=>{ot(A.config)||(clearInterval(t),D("login completed via SPA, starting scrape"),chrome.runtime.sendMessage({type:"LOGGED_IN"}),R("Logged in","Starting the scrape now…"),K(A.config))},1500);return}D("starting scrape immediately"),K(A.config)}function Ft(){dt(),q("connecting to Creator Lane…"),R("Connecting to Creator Lane","Checking whether this tab is part of a migration…");let t=!1;try{chrome.runtime.sendMessage({type:"REQUEST_RUN_CONFIG"},e=>{if(t=!0,chrome.runtime.lastError){W("REQUEST_RUN_CONFIG error:",chrome.runtime.lastError),N(`Couldn't reach the Creator Lane extension service worker: ${chrome.runtime.lastError.message}. Try reloading the extension at chrome://extensions.`);return}if(D("REQUEST_RUN_CONFIG response:",e),!e||!e.active){wt(),kt(),D("no active migration run for this tab — sitting idle");return}A.config=e.config,Bt()})}catch(e){W("sendMessage threw:",e),N(`Extension messaging failed: ${e.message}. Reload the extension and try again.`);return}setTimeout(()=>{t||(W("background did not respond within 5s"),N("The Creator Lane extension didn't respond. Open chrome://extensions and reload the Creator Lane Migration card, then click Start again from the dashboard."))},5e3)}chrome.runtime.onMessage.addListener((t,e,n)=>{if(t.type==="START_SCRAPE")return A.config=t.config,K(t.config),n({ok:!0}),!0;if(t.type==="IMPORT_FINISHED"){if(t.ok){const o=t.result||{},r=(o.created||[]).length,a=(o.skipped||[]).length,s=(o.duplicates||[]).length;ht(`Imported ${r} campaign${r===1?"":"s"}`,`Skipped ${a}, duplicates ${s}. Closing this tab in a few seconds — review them in Creator Lane.`)}else N(t.error||"Import failed");return n({ok:!0}),!0}});Ft();
})()
